...
class GeneticPopulation:
    ...
    def _evaluate_master(self):
        ...
        if self.evalCount == self.evals:
            ...
            # reposition robots and blocks to initial positions 
            self.controller.resetArena()
    ...
    def _distribute(self, individual):
        ...
        self.controller.emit(struct.pack("20000s", msg.encode("utf-8")))
    ...
    def _receive_genome(self, msg):
        ...
        received = struct.unpack("20000s", msg)[0].decode("utf-8").rstrip("\x00")
